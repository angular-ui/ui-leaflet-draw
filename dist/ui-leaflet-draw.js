 ...
 * @date: Mon Feb 20 2017 15:34:38 GMT+0800 (SGT)
 * @license: MIT
 */
...
(function (window, angular){
  ...
  angular.module('ui-leaflet').factory('leafletDrawEvents', [
...
(function() {
  ...
  angular.module('ui-leaflet').config([
    '$provide', function($provide) {
      return $provide.decorator('leafletDirective', [
